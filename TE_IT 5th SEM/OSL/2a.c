...
int main()
{
    ...
    pid_t cpid; // Move the cpid declaration here
    ...
    case 1:
        ...
        { // Parent process
            ...
            printf("\nAfter merge sorting by the parent process: ");
    ...
    case 2:
        ...
        { // Inside child process
            ...
            printf("\nAfter quick sorting in the child process: ");
        ...
        { // Parent process
            ...
            printf("\nThis is the parent process with pid: %d", getpid());
    ...
    case 3:
        ...
        { // Inside child process
            ...
            printf("\nThis is the child process with pid: %d", getpid());
